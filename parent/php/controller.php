...
abstract class ParentControl
{
	...
	public function __construct()
	{
		...
		$this->servername = $confidential_contents["database"]["bluehost"]["servername"];
		$this->dbname = $confidential_contents["database"]["bluehost"]["dbname"];
		$this->username = $confidential_contents["database"]["bluehost"]["username"];
		$this->password = $confidential_contents["database"]["bluehost"]["password"];
	}
